...
export function LoginFooter() {
  ...
  return (
    <>
      <footer className="absolute bottom-0 left-0 right-0 py-3 px-4">
          ...
          {links.map((link, index) => (
            <span key={link.key} className="flex items-center gap-4">
              ...
              <button
                ...
                className="text-zinc-500 dark:text-zinc-400 hover:text-yellow-600 dark:hover:text-yellow-400 transition-colors underline-offset-2 hover:underline"
              >
                {link.label}
              </button>
            </span>
